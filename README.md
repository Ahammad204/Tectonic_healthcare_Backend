# Tectonic Healthcare System — Backend
...
```
DATABASE_URL="postgresql://YOUR_USERNAME:YOUR_PASSWORD@localhost:5432/Tectonic_healthcare?schema=public"
```
...
# {"success":true,"message":"Welcome to Tectonic Healthcare System Backend"}
```
